...
void my_init(Env *env, Dict *kwargs) {
    ...
    c->density_lo = dict_get(kwargs, "density_lo")->value;
    c->density_hi = dict_get(kwargs, "density_hi")->value;
    c->n_hot_regions = (int)dict_get(kwargs, "n_hot_regions")->value;
    c->hot_radius = dict_get(kwargs, "hot_radius")->value;
    c->hot_bias = dict_get(kwargs, "hot_bias")->value;
    c->spawn_jitter = (int)dict_get(kwargs, "spawn_jitter")->value;
    c->fire_phase_jitter = (int)dict_get(kwargs, "fire_phase_jitter")->value;
    c->fire_cd_jitter = dict_get(kwargs, "fire_cd_jitter")->value;
    c->acq_jitter = dict_get(kwargs, "acq_jitter")->value;
    c->fspd_jitter = dict_get(kwargs, "fspd_jitter")->value;
    c->player_hp_jitter = dict_get(kwargs, "player_hp_jitter")->value;
    c->player_def_jitter = dict_get(kwargs, "player_def_jitter")->value;
    c->boss_hp_lo = dict_get(kwargs, "boss_hp_lo")->value;
    c->boss_hp_hi = dict_get(kwargs, "boss_hp_hi")->value;
    ...
    c->grate_prob = dict_get(kwargs, "grate_prob")->value;
